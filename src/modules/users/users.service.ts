...
export class UsersService {
  ...
  //   const reports = await Promise.all(inspections.map(async (inspection) => {
  ...
  //     const propertyOwner = inspection.property.created_by ? await this.userRepo.findOne({
  //           where: {
  //             id: inspection.property.created_by,
  //           },
  //           select: {
  //             id: true,
  //             first_name: true,
